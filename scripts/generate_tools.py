...
TOOL_COPY: Dict[str, List[Dict[str, Any]]] = {
    ...
    "fr": [
        {
            "title": "Boussole de Décision de Voyage",
            "type": "Outil de diagnostic en direct",
            "status": "Disponible",
            "status_key": "available",
            "description": "Un diagnostic d'adéquation structurelle sur les dix-sept structures de voyage — sept questions, adéquation classée, compromis énoncés.",
            "signals": ["Implémente le Structure Fit Protocol", "Fonctionne entièrement dans le navigateur", "Relié à l'ontologie"],
            "route": "compass",
            "action": "Lancer le diagnostic",
        },
        {
            "title": "Comparateur de styles de voyage",
            "type": "Outil de référence en direct",
            "status": "Disponible",
            "status_key": "available",
            "description": "Comparez les formes de voyage selon contraintes, autonomie, soutien, complexité et profondeur d'expérience.",
            "signals": ["Meilleur premier pas", "Relié aux critères", "Couvre tous les styles"],
            "route": "compare",
            "action": "Ouvrir la couche de comparaison",
        },
        {
            "title": "Carte de référence des 17 styles",
            "type": "Couche de référence en direct",
            "status": "Disponible",
            "status_key": "available",
            "description": "Explorez l'ontologie complète des styles de voyage avant d'affiner le bon choix.",
            "signals": ["17 styles structurés", "Pages de référence individuelles", "Couche multilingue"],
            "route": "styles",
            "action": "Explorer tous les styles",
        },
        {
            "title": "Cadre méthodologique",
            "type": "Doctrine de référence",
            "status": "Disponible",
            "status_key": "available",
            "description": "Comprenez comment TourVsTravel compare les formes de voyage sans les réduire à des étiquettes de préférence génériques.",
            "signals": ["Critères de décision", "Logique de notation", "Fondement conceptuel"],
            "route": "methodology",
            "action": "Lire la méthodologie",
        },
        {
            "title": "Trouvez votre correspondance",
            "type": "Outil de décision en direct",
            "status": "Disponible",
            "status_key": "available",
            "description": "Une couche d'appariement guidée qui convertit les contraintes du voyageur en orientations de styles recommandées.",
            "signals": ["Intention du voyageur", "Budget et charge", "Préférence d'autonomie"],
            "route": "find_your_match",
    ...
    "es": [
        {
            "title": "Brújula de Decisión de Viaje",
            "type": "Herramienta de diagnóstico en vivo",
            "status": "Disponible",
            "status_key": "available",
            "description": "Un diagnóstico de ajuste estructural sobre las diecisiete estructuras de viaje: siete preguntas, ajuste ordenado y contrapartidas declaradas.",
            "signals": ["Implementa el Structure Fit Protocol", "Funciona por completo en el navegador", "Enlazada a la ontología"],
            "route": "compass",
            "action": "Ejecutar el diagnóstico",
        },
        {
            "title": "Comparador de estilos de viaje",
            "type": "Herramienta de referencia en vivo",
            "status": "Disponible",
            "status_key": "available",
            "description": "Compara las formas de viaje por restricciones, autonomía, apoyo, complejidad y profundidad de experiencia.",
            "signals": ["El mejor primer paso", "Conectado a los criterios", "Cubre todos los estilos"],
            "route": "compare",
            "action": "Abrir la capa de comparación",
        },
        {
            "title": "Mapa de referencia de los 17 estilos",
            "type": "Capa de referencia en vivo",
            "status": "Disponible",
            "status_key": "available",
            "description": "Explora la ontología completa de estilos de viaje antes de afinar el ajuste correcto.",
            "signals": ["17 estilos estructurados", "Páginas de referencia individuales", "Capa multilingüe"],
            "route": "styles",
            "action": "Explorar todos los estilos",
        },
        {
            "title": "Marco metodológico",
            "type": "Doctrina de referencia",
            "status": "Disponible",
            "status_key": "available",
            "description": "Entiende cómo TourVsTravel compara las formas de viaje sin reducirlas a etiquetas de preferencia genéricas.",
            "signals": ["Criterios de decisión", "Lógica de puntuación", "Fundamento conceptual"],
            "route": "methodology",
            "action": "Leer la metodología",
        },
        {
            "title": "Encuentra tu mejor ajuste",
            "type": "Herramienta de decisión en vivo",
            "status": "Disponible",
            "status_key": "available",
            "description": "Una capa de emparejamiento guiada que convierte las restricciones del viajero en direcciones de estilo recomendadas.",
            "signals": ["Intención del viajero", "Presupuesto y carga", "Preferencia de autonomía"],
            "route": "find_your_match",
            "action": "Abrir la herramienta",
        },
    ],
    "de": [
        {
            "title": "Reise-Entscheidungskompass",
            "type": "Live-Diagnosewerkzeug",
            "status": "Verfügbar",
            "status_key": "available",
            "description": "Eine strukturelle Passungsdiagnose über alle siebzehn Reisestrukturen — sieben Fragen, geordnete Passung, benannte Zielkonflikte.",
            "signals": ["Implementiert das Structure Fit Protocol", "Läuft vollständig im Browser", "Mit der Ontologie verknüpft"],
            "route": "compass",
            "action": "Diagnose ausführen",
        },
        {
            "title": "Reisestil-Vergleicher",
            "type": "Live-Referenzwerkzeug",
            "status": "Verfügbar",
            "status_key": "available",
            "description": "Vergleichen Sie Reiseformen nach Beschränkungen, Autonomie, Unterstützung, Komplexität und Erlebnistiefe.",
            "signals": ["Bester erster Schritt", "Mit den Kriterien verbunden", "Deckt alle Stile ab"],
            "route": "compare",
            "action": "Vergleichsebene öffnen",
        },
        {
            "title": "Referenzkarte der 17 Stile",
            "type": "Live-Referenzebene",
            "status": "Verfügbar",
            "status_key": "available",
            "description": "Erkunden Sie die vollständige Reisestil-Ontologie, bevor Sie die richtige Passung eingrenzen.",
            "signals": ["17 strukturierte Stile", "Individuelle Referenzseiten", "Mehrsprachige Ebene"],
            "route": "styles",
            "action": "Alle Stile erkunden",
        },
        {
            "title": "Methodik-Rahmen",
            "type": "Referenzdoktrin",
            "status": "Verfügbar",
            "status_key": "available",
            "description": "Verstehen Sie, wie TourVsTravel Reiseformen vergleicht, ohne sie auf generische Präferenz-Etiketten zu reduzieren.",
            "signals": ["Entscheidungskriterien", "Bewertungslogik", "Konzeptionelle Grundlage"],
            "route": "methodology",
            "action": "Methodik lesen",
        },
        {
            "title": "Finden Sie die passende Wahl",
            "type": "Live-Entscheidungswerkzeug",
            "status": "Verfügbar",
            "status_key": "available",
            "description": "Eine geführte Matching-Ebene, die Reisebeschränkungen in empfohlene Stilrichtungen übersetzt.",
            "signals": ["Reiseabsicht", "Budget und Belastung", "Autonomiepräferenz"],
            "route": "find_your_match",
            "action": "Werkzeug öffnen",
        },
    ],
    "zh": [
        {
            ...
            "status": "可用",
            "status_key": "available",
            "description": "覆盖全部十七种旅行结构的结构适配诊断——七个问题、排序适配、明示取舍。",
            "signals": ["实现结构适配协议", "完全在浏览器中运行", "与本体相连"],
            "route": "compass",
            "action": "运行诊断",
        },
        {
            ...
            "status": "可用",
            "status_key": "available",
            "description": "按约束、自主性、支持、复杂度与体验深度比较旅行形式。",
            "signals": ["最佳第一步", "连接比较标准", "覆盖所有风格"],
            "route": "compare",
            "action": "打开比较层",
        },
        {
            ...
            "status": "可用",
            "status_key": "available",
            "description": "在确定合适选择之前，探索完整的旅行风格本体。",
            "signals": ["17种结构化风格", "独立参考页面", "多语言层"],
            "route": "styles",
            "action": "探索所有风格",
        },
        {
            ...
            "status": "可用",
            "status_key": "available",
            "description": "了解 TourVsTravel 如何比较旅行形式，而不将其简化为通用偏好标签。",
            "signals": ["决策标准", "评分逻辑", "概念基础"],
            "route": "methodology",
            "action": "阅读方法论",
        },
        {
            ...
            "status": "可用",
            "status_key": "available",
            "description": "一个引导式匹配层，把旅行者约束转化为推荐的风格方向。",
            "signals": ["旅行者意图", "预算与负担", "自主偏好"],
            "route": "find_your_match",
            "action": "打开工具",
        },
    ],
    "ja": [
        {
            "title": "トラベル・ディシジョン・コンパス",
            "type": "ライブ診断ツール",
            "status": "利用可能",
            "status_key": "available",
            "description": "17の旅行構造すべてを対象とする構造適合診断——7つの質問、適合順位、明示されたトレードオフ。",
            "signals": ["構造適合プロトコルを実装", "完全にブラウザ内で動作", "オントロジーと連携"],
            "route": "compass",
            "action": "診断を実行",
        },
        {
            ...
            "status": "利用可能",
            "status_key": "available",
            "description": "制約、自律性、サポート、複雑さ、体験の深さで旅行形式を比較する。",
            "signals": ["最適な第一歩", "基準と連動", "全スタイルに対応"],
            "route": "compare",
            "action": "比較レイヤーを開く",
        },
        {
            "title": "17スタイル・リファレンスマップ",
            "type": "ライブリファレンス層",
            "status": "利用可能",
            "status_key": "available",
            "description": "適切な選択を絞り込む前に、旅行スタイルの完全なオントロジーを探索する。",
            "signals": ["17の構造化スタイル", "個別リファレンスページ", "多言語レイヤー"],
            "route": "styles",
            "action": "すべてのスタイルを見る",
        },
        {
            ...
            "status": "利用可能",
            "status_key": "available",
            "description": "TourVsTravel が旅行形式を一般的な好みのラベルに還元せずに比較する方法を理解する。",
            "signals": ["意思決定基準", "スコアリングロジック", "概念的基盤"],
            "route": "methodology",
            "action": "方法論を読む",
        },
        {
            ...
            "status": "利用可能",
            "status_key": "available",
            "description": "旅行者の制約を推奨スタイルの方向へ変換するガイド付きマッチング層。",
            "signals": ["旅行者の意図", "予算と負担", "自律性の好み"],
            "route": "find_your_match",
            "action": "ツールを開く",
        },
    ],
...
SYSTEM_STEPS: Dict[str, List[Dict[str, str]]] = {
    ...
    "es": [
        {"label": "Paso 1", "value": "Identificar la forma de viaje."},
        {"label": "Paso 2", "value": "Comparar restricciones y contrapartidas."},
        {"label": "Paso 3", "value": "Avanzar hacia el ajuste, no la preferencia genérica."},
    ],
    "de": [
        {"label": "Schritt 1", "value": "Die Reiseform bestimmen."},
        {"label": "Schritt 2", "value": "Beschränkungen und Zielkonflikte vergleichen."},
        {"label": "Schritt 3", "value": "Zur Passung gehen, nicht zur generischen Präferenz."},
    ],
    "zh": [
        {"label": "第一步", "value": "识别旅行形式。"},
        {"label": "第二步", "value": "比较约束与取舍。"},
        {"label": "第三步", "value": "走向适配，而非泛泛偏好。"},
    ],
    "ja": [
        {"label": "ステップ1", "value": "旅行形式を特定する。"},
        {"label": "ステップ2", "value": "制約とトレードオフを比較する。"},
        {"label": "ステップ3", "value": "一般的な好みではなく適合へ進む。"},
    ],
}
