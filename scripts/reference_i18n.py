...
LOCALIZED_UI: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "footer_ontology_label": "Travel Structure Ontology",
        "footer_standard_label": "Integrity Standard (TDIS)",
        "footer_changelog_label": "Changelog",
    ...
    "ar": {
        ...
        "footer_ontology_label": "أنطولوجيا بنى السفر",
        "footer_standard_label": "معيار السلامة (TDIS)",
        "footer_changelog_label": "سجل التغييرات",
    ...
    "fr": {
        ...
        "footer_ontology_label": "Ontologie des structures",
        "footer_standard_label": "Standard d'intégrité (TDIS)",
        "footer_changelog_label": "Journal des modifications",
    ...
    "es": {
        ...
        "footer_ontology_label": "Ontología de estructuras",
        "footer_standard_label": "Estándar de integridad (TDIS)",
        "footer_changelog_label": "Registro de cambios",
    ...
    "de": {
        ...
        "footer_ontology_label": "Ontologie der Reisestrukturen",
        "footer_standard_label": "Integritätsstandard (TDIS)",
        "footer_changelog_label": "Änderungsprotokoll",
    ...
    "zh": {
        ...
        "footer_ontology_label": "旅行结构本体",
        "footer_standard_label": "完整性标准（TDIS）",
        "footer_changelog_label": "更新日志",
    ...
    "ja": {
        ...
        "footer_ontology_label": "旅行構造オントロジー",
        "footer_standard_label": "インテグリティ基準（TDIS）",
        "footer_changelog_label": "変更履歴",
